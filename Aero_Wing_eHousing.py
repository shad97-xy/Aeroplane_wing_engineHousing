...
p_0 = hsf.add_new_point_coord(108, 25, 0)
p_0.name = "p_0"
construction_elements.append_hybrid_shape(p_0)

# Create a point in Z axis
p_blade = hsf.add_new_point_coord(108, 25, 200)
...
## Create a point in Z axis
p_hub = hsf.add_new_point_coord(108, 25, -135)
p_hub.name = "p_z"
...
p_hub1 = hsf.add_new_point_coord(108, 25, -145)
p_hub1.name = "p1_z"
...
p_hub2 = hsf.add_new_point_coord(108, 25, -150)
p_hub2.name = "p2_z"
...
p_hub3 = hsf.add_new_point_coord(108, 25 , -127)
p_hub3.name = "p3_z"
...
p_hub4 = hsf.add_new_point_coord(108, 25 , -100)
p_hub4.name = "p4_z"
...
p_hub5 = hsf.add_new_point_coord(108, 25, -80)
p_hub5.name = "p5_z"
...
p_hub6 = hsf.add_new_point_coord(108, 25 , -60)
p_hub6.name = "p6_z"
...
p_hub7 = hsf.add_new_point_coord(108, 25 , -45)
p_hub7.name = "p7_z"
